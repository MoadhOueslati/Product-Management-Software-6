...
# Form implementation generated from reading ui file 'styles/sell.ui'
#
...
"")
        ...
        self.costumerlineEdit = QtWidgets.QLineEdit(self.widget_2)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.costumerlineEdit.setFont(font)
        self.costumerlineEdit.setObjectName("costumerlineEdit")
        self.gridLayout_2.addWidget(self.costumerlineEdit, 2, 1, 1, 1)
        ...
        self.quantiteVendueSpinBox = QtWidgets.QSpinBox(self.widget_2)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.quantiteVendueSpinBox.setFont(font)
        self.quantiteVendueSpinBox.setMaximum(999999)
        self.quantiteVendueSpinBox.setObjectName("quantiteVendueSpinBox")
        self.gridLayout_2.addWidget(self.quantiteVendueSpinBox, 0, 1, 1, 1)
        self.prixVendueDoubleSpinBox = QtWidgets.QDoubleSpinBox(self.widget_2)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.prixVendueDoubleSpinBox.setFont(font)
        self.prixVendueDoubleSpinBox.setDecimals(1)
        self.prixVendueDoubleSpinBox.setMaximum(999999.0)
        self.prixVendueDoubleSpinBox.setObjectName("prixVendueDoubleSpinBox")
        self.gridLayout_2.addWidget(self.prixVendueDoubleSpinBox, 1, 1, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_8.setText(_translate("Dialog", "Prix de Vente (dt) :"))
        self.label_10.setText(_translate("Dialog", "Date d\'Entrée :"))
        self.label_9.setText(_translate("Dialog", "Nom du Client :"))
        self.label_11.setText(_translate("Dialog", "Notes :"))
        self.label_7.setText(_translate("Dialog", "Quantité Vendue :"))
        self.enregistrerButton.setText(_translate("Dialog", "Enregistrer"))
        self.annulerButton.setText(_translate("Dialog", "Annuler"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("Dialog", "Vendue"))
